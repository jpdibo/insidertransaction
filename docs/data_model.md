...
Filing and event facts are versioned. Current pointers do not erase prior versions. Source records can have multiple immutable document hashes. Detailed rows and reported aggregates coexist; if details exist they alone receive `selected_for_analytics=1`.
