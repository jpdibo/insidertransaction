...
- Forty-six system and adapter-contract tests pass on 09 September 2026.
...
- The local canonical database contains 322 current events: 316 official events across seven jurisdictions and six synthetic controls. See `docs/country_history.md` for the step-by-step jurisdiction ledger.
