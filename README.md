...
- The local canonical database contains 396 current events: 390 official events across seven jurisdictions and six synthetic controls. See `docs/country_history.md` for the step-by-step jurisdiction ledger.
